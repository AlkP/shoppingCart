...
ActiveRecord::Schema.define(version: 20150620122229) do
  ...
  add_index "discounts", ["variety_id"], name: "index_discounts_on_variety_id"
  ...
  add_index "varieties", ["type_id"], name: "index_varieties_on_type_id"
